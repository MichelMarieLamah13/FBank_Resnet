...
python trainRESNETModel.py --lr 0.01 --save_path exps/exp_test_param_lr --train_list ./lists/train_list.txt  --train_path /local_disk/atlantia/laboinfo/matrouf/VOXCELEB_2023/voxceleb_trainer/data/voxceleb2/ --eval_list ./lists/veri_test2.txt --eval_path /local_disk/atlantia/laboinfo/matrouf/VOXCELEB_2023/voxceleb_trainer/data/TEST/wav/ --musan_path /local_disk/atlantia/laboinfo/matrouf/VOXCELEB_2023/voxceleb_trainer/data/musan_split --rir_path /local_disk/atlantia/laboinfo/matrouf/VOXCELEB_2023/voxceleb_trainer/data/RIRS_NOISES/simulated_rirs/
